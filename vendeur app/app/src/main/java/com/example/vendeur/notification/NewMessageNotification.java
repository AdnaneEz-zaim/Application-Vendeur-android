...
public class NewMessageNotification {
    ...
    public static void notify(final Context context,
        ...
        final Bitmap picture = BitmapFactory.decodeResource(res, R.drawable.notify_logo);


        final String ticker = exampleString;
        final String title = "Vendeur app";
        final String text =   exampleString ;

        Intent resultIntent = new Intent(context, espaceVendeur.class);
